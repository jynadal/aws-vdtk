...
const avodData: AVOD[] = [
  {
    logo: "/images/avod/oqee_logo.jpeg",
    name: "Oqee",
    //video: "https://youtu.be/uLZG3O08L2Y",
    description:"src/components/Tables",
    nbrSubLink: 806,
    followersX: 6,
    country: "France",
  },
  {
    logo: "/images/avod/oqee.svg",
    name: "Oqee",
    description:"src/components/Tables",
    nbrSubLink: 806,
    followersX: 6,
...
const CompanyView = () => {
  return (
  <>
    {avodData.map((profil, key) => (

    <div className="mx-auto max-w-242.5" key={key}>
        <Breadcrumb pageName={profil.name} />
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">{profil.country}</p>
              <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    {profil.nbrSubLink}
                  </span>
                  <span className="text-sm">Linkedinn</span>
                </div>
                <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
                  <span className="font-semibold text-black dark:text-white">
                    {profil.followersX}
